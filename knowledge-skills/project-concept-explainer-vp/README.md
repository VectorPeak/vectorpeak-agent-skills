...
<p align="center">
  ...
  <a href="./"><img src="https://img.shields.io/badge/project--concept--explainer--vp-study-blueviolet" alt="project concept explainer vp"></a>
...
```text
使用 project-concept-explainer-vp，解释这个项目里的 BM25、FAISS、Hard Negative Mining
```
...
```text
使用 project-concept-explainer-vp，比较 BM25、MiniLM、SimCSE 和 Hard Negative Mining
```
...
```text
使用 project-concept-explainer-vp，扫描当前项目并生成一份项目知识地图
```
...
```text
使用 project-concept-explainer-vp，把这个仓库的核心术语整理成 docs/glossary.md
```
