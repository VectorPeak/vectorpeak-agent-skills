...
├── pr-workflow-vp/     # 开源 PR 工作流
├── profile-readme-vp/  # GitHub Profile README 自动更新工作流
└── README.md           # 工程类技能目录说明
```
...
- [`pr-workflow-vp`](pr-workflow-vp/)：管理开源 PR 工作流，覆盖 fork/clone、候选 bug 发现、多 Agent 审查、PR 草稿、评论修改和确认后提交。
- [`profile-readme-vp`](profile-readme-vp/)：生成 VectorPeak GitHub Profile README，支持公开项目 facts 收集、stars 更新、中英双语表格、自动补全新公开仓库，并排除 `VectorPeak/VectorPeak` profile 仓库本身。
